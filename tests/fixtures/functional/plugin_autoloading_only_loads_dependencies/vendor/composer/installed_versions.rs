...
impl InstalledVersions {
    ...
    pub fn getInstalledPackagesByType(r#type: serde_json::Value) {
        todo!()
    }

    pub fn isInstalled(packageName: serde_json::Value, includeDevRequirements: serde_json::Value) {
        todo!()
    }
    ...
    pub fn getInstallPath(packageName: serde_json::Value) {
        todo!()
    }
